...
**Concept:** A metric that quantifies system volatility by analyzing the drift between Valid Time and Transaction Time (Retcons and Prophecies).
**Fate:** Merged (Experimental)
**Lesson:** While individual retcons are interesting, the *aggregate* volatility of the system is a signal of instability or active prediction.
