...
## Entropy Gauge
**Concept:** A metric that tracks "Temporal Drift" (Valid Time vs Transaction Time divergence), counting Retcons and Prophecies to quantify timeline stability.
**Fate:** Merged (Experimental)
**Lesson:** If you measure how much you are rewriting history, you might find out if you are the villain of your own story.
