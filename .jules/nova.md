...
## Entropy Gauge
**Concept:** A system stability metric that quantifies "drift" between Transaction Time and Valid Time.
**Fate:** Merged (Experimental)
**Lesson:** Quantifying "time travel" (retcons and prophecies) provides a concrete health metric for the system's temporal integrity.
