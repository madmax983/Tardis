...
## Entropy Gauge
**Concept:** A system-wide metric that calculates "Temporal Entropy" by measuring the ratio of Retcons (corrections) and Prophecies (predictions) to total knowledge versions.
**Fate:** Merged (Experimental)
**Lesson:** While individual histories tell stories, a single "Stability Score" allows us to monitor the overall health of the timeline. High entropy means the system is either guessing too much or fixing too many mistakes.
