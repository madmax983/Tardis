...
//!
//! Consolidated domain model containing:
//! - Conversation entities (Message, Session)
//! - Knowledge graph entities (Entity, Relationship)
//! - System state entities (Snapshot, `SystemState`)
